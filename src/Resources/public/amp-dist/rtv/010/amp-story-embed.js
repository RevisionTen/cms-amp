...
function () {
   ...
   * @constructor
   */
  function AmpStoryEmbed(doc, element) {
    console.
    /*OK*/
    assert(element.childElementCount > 0, 'Missing configuration.');
    /** @private {!Element} */
  ...
  var _proto = AmpStoryEmbed.prototype;

  _proto.build = function build() {
    this.initializeShadowRoot_(); // TODO: Build all child iframes.
  ...
  _proto.initializeShadowRoot_ = function initializeShadowRoot_() {
    // Create shadow root
    var shadowRoot = this.element_.attachShadow({
      mode: 'open'
  ...
  _proto.buildIframe_ = function buildIframe_(index) {
    var story = this.stories_[index];
    this.iframeEl_ = this.doc_.createElement('iframe');
    this.iframeEl_.setAttribute('src', story.href);
    (0, _style.setStyle)(this.iframeEl_, 'backgroundImage', story.getAttribute('data-poster-portrait-src'));
  ...
  _proto.initializeLoadingListeners_ = function initializeLoadingListeners_() {
    var _this = this;

    this.rootEl_.classList.add(LoadStateClass.LOADING);

    this.iframeEl_.onload = function () {
      _this.rootEl_.classList.remove(LoadStateClass.LOADING);

      _this.rootEl_.classList.add(LoadStateClass.LOADED);
    };

    this.iframeEl_.onerror = function () {
      _this.rootEl_.classList.remove(LoadStateClass.LOADING);

      _this.rootEl_.classList.add(LoadStateClass.ERROR);
    };
  };
...
exports.AmpStoryEmbed = AmpStoryEmbed;
var doc = self.document;
var embeds = doc.getElementsByTagName('amp-story-embed');

for (var i = 0; i < embeds.length; i++) {
  var embed = embeds[i];
  var embedImpl = new AmpStoryEmbed(doc, embed);
  embedImpl.build();
}

},{"../src/style":8}],2:[function(require,module,exports){
"use strict";
...
},{"./config":2,"./internal-version":3,"./mode":6,"./mode-object":5,"./types":9,"./utils/function":12}],5:[function(require,module,exports){
"use strict";
...
},{"./internal-version":3,"./url-parse-query-string":10}],7:[function(require,module,exports){
"use strict";
...
},{"./log":4,"./string":7,"./utils/object.js":13}],9:[function(require,module,exports){
"use strict";
...
//# sourceMappingURL=amp-story-embed.js.map
